...
if not len(sys.argv) in [6]:
    sys.stderr.write('Usage: %s <beta_G> <lambda> <msq> <beta_U1> <r_u1>\n' %
                     sys.argv[0])
    sys.exit(1)
...
print('---- Read in: beta_G = %g, lambda = %g, msq = %g, beta_U1 = %g, r_u1 = %g ----\n'
